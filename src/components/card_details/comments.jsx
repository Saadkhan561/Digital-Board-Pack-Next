  ...
  return (
    <div className="flex gap-5 p-2">
      <div className="border h-fit mt-2 rounded-full p-2">
        <img className="menu_bar_div:h-[10px] menu_bar_mob:w-[10px]" src="/images/account.png" alt="" height={20} width={20} />
      </div>
      <div className="p-2 w-4/5 ml-2">
        <div className="flex gap-5 items-center">
          <p className="text-md menu_bar_mob:text-sm font-semibold">Senior Manager</p>
