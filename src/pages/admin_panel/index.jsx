...
const AdminPanel = () => {
  ...
  return (
    <div className="flex justify-center items-center relative">
      <div className={router.query.signUp ? "p-10 h-screen w-4/5 flex flex-col gap-10 opacity-50 duration-200":"p-10 h-screen w-4/5 flex flex-col gap-10"}>
        <div className="flex justify-between items-center border-b border-b-slate-300 pb-5">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-black text-white font-semibold rounded-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div onClick={() => router.push('?signUp=true')} className="font-semibold text-sm border border-slate-300 p-1 rounded-md cursor-pointer hover:bg-slate-200 duration-200 w-max">
              Add a new user
            </div>
          </div>
        </div>
